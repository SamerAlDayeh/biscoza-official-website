...
const SectionHeader = ({ subtitle }) => {
  ...
  return (
    <div className={commonStyles.headerWrapper}>
      ...
      <h2 className={commonStyles.headerTitle}>{t("biscuits_browse")}</h2>
    </div>
  );
};
...
const Biscuits = () => {
  ...
  const filters = [
    { id: "marshmallow", label: t("biscuits_filter_marshmallow") },
    { id: "coated", label: t("biscuits_filter_coated") },
    { id: "jelly", label: t("biscuits_filter_jelly") },
    { id: "cream", label: t("biscuits_filter_cream") },
  ];
  ...
  return (
    <div className="biscuit-container">
      <div className={commonStyles.container}>
        <SectionHeader subtitle={t("biscuits_quality_subtitle")} />
